...
\begin{figure}[tb]
\centering
\includegraphics[width=0.2\textwidth]{./pic/test2LaTeX_70_0.png}
...
See Listing~\ref{lst:autolistingcell72} for the code this figure is not given meta data caption parameters, it will be inlined in the latex export.

\begin{center}
\includegraphics[scale=0.3]{./pic/test2LaTeX_72_0.png}
\end{center}
...
See Listing~\ref{lst:autolistingcell74} for the code.
...
\begin{figure}[tb]
\centering
\includegraphics[scale=0.5]{./pic/test2LaTeX_76_0.png}
\caption{Caption text for (first) fourth figure\label{fig:lab4-0}}
\end{figure}

\begin{center}
\includegraphics[scale=0.5]{./pic/test2LaTeX_76_1.png}
\end{center}


\begin{figure}[tb]
\centering
\includegraphics[scale=0.5]{./pic/test2LaTeX_76_2.png}
...
See Listing~\ref{lst:autolistingcell79} for the code.
...
See Listing~\ref{lst:autolistingcell84} for the code  type(eval("this is a test string")) is not list.
...
See Listing~\ref{lst:autolistingcell100} for the code.
...
See Listing~\ref{lst:autolistingcell104} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell105} for the code.
...
See Listing~\ref{lst:autolistingcell107} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell109} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell111} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell112} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell116} for the code  to format a numy array in \LaTeX{}.
...
See Listing~\ref{lst:autolistingcell125} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 70}, label=lst:figurelisting]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 79}, label=lst:autolistingcell79]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 100}, label=lst:autolistingcell100]
import pandas as pd
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 114}, label=lst:autolistingcell114]
##
lstr = '\n\nThis paragraph is embedded as \LaTeX{} in a Jupyter output cell. '\
            + 'One day this could be a complex computed \LaTeX{} string.  '\
            + 'This example only has rising rules...  \n'
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 125}, label=lst:autolistingcell125]
