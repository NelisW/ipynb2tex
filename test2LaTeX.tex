...
See Listing~\ref{lst:autolistingcell72} for the code  type(eval("this is a test string")) is not list.
...
See Listing~\ref{lst:autolistingcell88} for the code.
...
See Listing~\ref{lst:autolistingcell93} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell94} for the code.
...
See Listing~\ref{lst:autolistingcell96} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell98} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell102} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell103} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell107} for the code  to format a numy array in \LaTeX{}.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 54}, label=lst:autolistingcell54]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 60}, label=lst:autolistingcell60]
plots = []
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 63}, label=lst:autolistingcell63]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 103}, label=lst:autolistingcell103]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 105}, label=lst:autolistingcell105]
##
lstr = '\n\nThis paragraph is embedded as \LaTeX{} in a Jupyter output cell. '\
            + 'One day this could be a complex computed \LaTeX{} string.  '\
            + 'This example only has rising rules...  \n\n'
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 107}, label=lst:autolistingcell107]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 127}, label=lst:autolistingcell127]
##
