...
Width has precedence over scale and if width is given, scale is ignored.
...
See Listing~\ref{lst:autolistingcell73} for the code this figure is not given meta data caption parameters, it will be inlined in the latex export.

\begin{center}
\includegraphics[scale=0.3]{./pic/test2LaTeX_73_0.png}
\end{center}
...
See Listing~\ref{lst:autolistingcell75} for the code.


\begin{figure}[tb]
\centering
\includegraphics[width=0.3\textwidth]{./pic/test2LaTeX_75_0.png}
...
See Listing~\ref{lst:autolistingcell77} for the code.


\begin{figure}[tb]
\centering
\includegraphics[scale=0.5]{./pic/test2LaTeX_77_0.png}
\caption{Caption text for (first) fourth figure\label{fig:lab4-0}}
\end{figure}

\begin{center}
\includegraphics[scale=0.5]{./pic/test2LaTeX_77_1.png}
\end{center}


\begin{figure}[tb]
\centering
\includegraphics[scale=0.5]{./pic/test2LaTeX_77_2.png}
...
See Listing~\ref{lst:autolistingcell85} for the code  type(eval("this is a test string")) is not list.
...
\item list item5  [ this should work correctly ]   
     ...
     item5 new parra 1    [ this should work correctly ]   
...
See Listing~\ref{lst:autolistingcell101} for the code.
...
See Listing~\ref{lst:autolistingcell105} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell106} for the code.
...
See Listing~\ref{lst:autolistingcell108} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell110} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell112} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell113} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell117} for the code  to format a numy array in \LaTeX{}.
...
See Listing~\ref{lst:autolistingcell126} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 73}, label=lst:autolistingcell73]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 75}, label=lst:autolistingcell75]
%matplotlib inline
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 77}, label=lst:autolistingcell77]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 110}, label=lst:autolistingcell110]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 112}, label=lst:autolistingcell112]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 117}, label=lst:autolistingcell117]
