...
See Listing~\ref{lst:autolistingcell41} for the code.
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.2\textwidth]{./pic/test2LaTeX_45_0.png}
...
See Listing~\ref{lst:autolistingcell48} for the code this figure is not given meta data caption parameters, it will be inlined in the latex export.

\begin{center}
\includegraphics[width=0.3\textwidth]{./pic/test2LaTeX_48_0.png}
\end{center}
...
See Listing~\ref{lst:autolistingcell50} for the code.


\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{./pic/test2LaTeX_50_0.png}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.5\textwidth]{./pic/test2LaTeX_52_0.png}
\caption{Caption text for (first) fourth figure\label{fig:lab4-0}}
\end{figure}

\begin{center}
\includegraphics[width=0.5\textwidth]{./pic/test2LaTeX_52_1.png}
\end{center}


\begin{figure}[tb]
\centering
\includegraphics[width=0.5\textwidth]{./pic/test2LaTeX_52_2.png}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.9\textwidth]{./images/discretestrata01.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.9\textwidth]{./images/Bankedturn.pdf}
...
See Listing~\ref{lst:autolistingcell91} for the code.
...
See Listing~\ref{lst:autolistingcell94} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell95} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell99} for the code  to format a numy array in \LaTeX{}.
...
See Listing~\ref{lst:autolistingcell119} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 32}, label=lst:listing1]
# to prepare the environment
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 34}, label=lst:listing2]
#
print(' ')
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 35}, label=lst:listing3]
# to print the value
a = ['a','b']
for v in a:
    print(v)
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 41}, label=lst:autolistingcell41]
for i in [1,2,3]:
    si = str(i)
    v = doprint(si)
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 45}, label=lst:figurelisting]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 50}, label=lst:autolistingcell50]
%matplotlib inline
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 91}, label=lst:autolistingcell91]
Write latex strings
\end{lstlisting}
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 99}, label=lst:autolistingcell99]
