...
See Listing~\ref{lst:autolistingcell124} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 124 \label{lst:autolistingcell124}}]
