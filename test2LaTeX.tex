...
\begin{normalsize}
\includegraphics[width=0.2\textwidth, angle=0]{./pic/test2LaTeX_42_0.png}
\end{normalsize}
\caption{Caption text for first figure\label{fig:lab1-0}\label{fig:lab1}}
\end{figure}
...
\begin{center}
\includegraphics[width=0.9\textwidth, angle=0]{./pic/test2LaTeX_45_0.png}
\end{center}
...
\begin{normalsize}
\includegraphics[width=0.4\textwidth, angle=0]{./pic/test2LaTeX_47_0.png}
\end{normalsize}
...
\begin{normalsize}
\includegraphics[width=0.4\textwidth, angle=0]{./pic/test2LaTeX_51_0.png}
\end{normalsize}
...
See Listing~\ref{lst:autolistingcell53} for the code.
...
\begin{normalsize}
\includegraphics[width=0.4\textwidth, angle=0]{./pic/test2LaTeX_53_0.png}
\end{normalsize}
...
\begin{center}
\includegraphics[width=0.9\textwidth, angle=0]{./pic/test2LaTeX_53_1.png}
\end{center}
{
...
\begin{normalsize}
\includegraphics[width=0.5\textwidth, angle=0]{./pic/test2LaTeX_53_2.png}
\end{normalsize}
...
See Listing~\ref{lst:autolistingcell56} for the code.
...
\begin{normalsize}
\includegraphics[width=0.3\textwidth, angle=0]{./pic/test2LaTeX_56_0.png}
\end{normalsize}
...
\begin{normalsize}
\includegraphics[width=0.5\textwidth, angle=0]{./pic/test2LaTeX_56_1.png}
\end{normalsize}
...
See Listing~\ref{lst:autolistingcell59} for the code.
...
\begin{normalsize}
\includegraphics[width=0.2\textwidth, angle=0]{./pic/test2LaTeX_59_0.png}
\end{normalsize}
...
\begin{normalsize}
\includegraphics[width=0.2\textwidth, angle=0]{./pic/test2LaTeX_59_1.png}
\end{normalsize}
...
\begin{normalsize}
\includegraphics[width=0.2\textwidth, angle=0]{./pic/test2LaTeX_59_2.png}
\end{normalsize}
...
See Listing~\ref{lst:autolistingcell62} for the code.
...
See Listing~\ref{lst:autolistingcell71} for the code  type(eval("this is a test string")) is not list.
...
\begin{normalsize}
\includegraphics[width=0.1\textwidth, angle=0]{./images/random-squares-2.png}
\end{normalsize}
\caption{Boxy picture\label{fig:propflightpaths-0}\label{fig:propflightpaths}}
\end{figure}
...
\begin{table}[tb]
\centering
\caption{Caption text for first table\label{tab:lab1-0}\label{tab:lab1}}
...
\begin{table}[tb]
\centering
\caption{Caption text for (first) second table\label{tab:lab2-0}\label{tab:lab2}}
...
\begin{table}[tb]
\centering
\caption{Caption text for hierarchical table\label{tab:hiertab12-0}\label{tab:hiertab12}}
...
See Listing~\ref{lst:autolistingcell87} for the code.
...
\subsection{Font size in tables}
\label{sec:Fontsizeintables}
...
See Listing~\ref{lst:autolistingcell92} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell93} for the code.
...
See Listing~\ref{lst:autolistingcell95} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell97} for the code  to write a floating table in tiny font size.

{

\begin{table}[tb]
\centering
\caption{Caption text for the Pandas table\label{tab:labpad1-0}\label{tab:labpad1}}
% to get unbroken vertical lines with booktabs, set separators to zero
% also set all horizontal lines to same width
\aboverulesep=0ex
\belowrulesep=0ex
...
See Listing~\ref{lst:autolistingcell101} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell102} for the code  display another tikz graphic, as a floating figure.
...
\end{tikzpicture}
\end{normalsize}
\caption{Caption text for tikz figure\label{fig:tikz-0}\label{fig:tikz}}
\end{figure}
...
See Listing~\ref{lst:autolistingcell106} for the code  to format a numy array in \LaTeX{}.
...
\begin{lstlisting}[style=incellstyle,caption={Caption text for first listing}, label=lst:listing1]
# to prepare the environment
...
\begin{lstlisting}[style=incellstyle,caption={Caption text for second listing}, label=lst:listingrad]
#
print(' ')
...
\begin{lstlisting}[style=incellstyle,caption={Caption text for third listing}, label=lst:listing3]
# to print the value
a = ['a','b']
for v in a:
    print(v)
...
\begin{lstlisting}[style=incellstyle,caption={Listing caption in cell with a figure}, label=lst:figurelisting]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 53}, label=lst:autolistingcell53]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 56}, label=lst:autolistingcell56]
import pyradi.ryplot as ryplot
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 59}, label=lst:autolistingcell59]
plots = []
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 71}, label=lst:autolistingcell71]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 92}, label=lst:autolistingcell92]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 95}, label=lst:autolistingcell95]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 97}, label=lst:autolistingcell97]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 101}, label=lst:autolistingcell101]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 102}, label=lst:autolistingcell102]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 106}, label=lst:autolistingcell106]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 126}, label=lst:autolistingcell126]
##
