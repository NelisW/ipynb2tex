...
The above code only displays the second iframe, it seems to overwrite the first.
...
See Listing~\ref{lst:autolistingcell90} for the code  type(eval("this is a test string")) is not list.
...
See Listing~\ref{lst:autolistingcell110} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell111} for the code.
...
See Listing~\ref{lst:autolistingcell113} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell115} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell117} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell118} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell122} for the code  to format a numy array in \LaTeX{}.
...
See Listing~\ref{lst:autolistingcell131} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 131}, label=lst:autolistingcell131]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 132}, label=lst:autolistingcell132]
