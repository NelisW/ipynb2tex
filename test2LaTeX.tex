...
The table format specification is provided by the Pandas  to\_latex(column\_format)\cite{httppandaspydataorgpandas} argument,  as in
...
See Listing~\ref{lst:autolistingcell76} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
{} &         A &         B &         C &         D \\
\midrule
2013-01-01 & -1.268282 &  1.812701 & -0.201025 &  0.797597 \\
2013-01-02 &  1.047219 &  0.281324 & -1.890740 &  1.591323 \\
2013-01-03 &  1.109811 & -0.200233 & -0.844918 & -0.629818 \\
2013-01-04 &  1.591857 & -0.285774 &  0.587640 & -2.948210 \\
2013-01-05 &  0.940730 & -1.167735 & -2.340891 &  0.124803 \\
2013-01-06 & -0.277566 &  0.070237 & -0.300494 & -0.566420 \\
\bottomrule
\end{tabular}
...
See Listing~\ref{lst:autolistingcell78} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell80} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell82} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell83} for the code  display another tikz graphic, as a floating figure.
...
Jelte Fennema wrote pylatex\cite{httpsgithubcomJelteFPyLaT} to create LaTeX text using Python code.  He wrote the code to create complete documents, but also to write  fragments\cite{httpsjeltefgithubioPyLaTe} --- which we can use here: "Classes can be part of a single document, or can act as pieces on their own. With the \verb+dumps\_as\_content+ method, most classes can return their LaTeX-formatted code, and with the \verb+generate\_tex+ method, this code can be written to a file."
...
See Listing~\ref{lst:autolistingcell87} for the code  to format a numy array in \LaTeX{}.

\[%
arr= \begin{bmatrix}%
-0.318321849373&2.56329278694&-2.12719181446&0.0729062460686\\%
0.931586498395&-0.00295785179876&-0.152603517505&-0.906774902076\\%
-0.420618972082&-1.09147819961&1.42667946538&0.242862131114\\%
-1.47914392887&0.174836316235&0.898639169037&0.0439616278845\\%
-0.493898711242&-0.0240584674892&-0.468508030406&0.311000429564\\%
-0.996791597898&1.50090062979&-1.30433976844&-1.10215774509%
\end{bmatrix}%
\]
...
See Listing~\ref{lst:autolistingcell95} for the code.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 83 \label{lst:autolistingcell83}}]
