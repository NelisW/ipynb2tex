...
See Listing~\ref{lst:autolistingcell85} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
See Listing~\ref{lst:autolistingcell86} for the code.
...
See Listing~\ref{lst:autolistingcell88} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell90} for the code  to write a floating table in tiny font size.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 86}, label=lst:autolistingcell86]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 90}, label=lst:autolistingcell90]
