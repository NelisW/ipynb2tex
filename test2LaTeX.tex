...
\begin{figure}[tb]
\centering
\includegraphics{./pic/test2LaTeX_70_0.png}
...
\begin{center}
\includegraphics{./pic/test2LaTeX_72_0.png}
\end{center}
...
\begin{figure}[tb]
\centering
\includegraphics{./pic/test2LaTeX_74_0.png}
...
\begin{figure}[tb]
\centering
\includegraphics{./pic/test2LaTeX_76_0.png}
\caption{Caption text for (first) fourth figure\label{fig:lab4-0}}
\end{figure}

\begin{center}
\includegraphics{./pic/test2LaTeX_76_1.png}
\end{center}


\begin{figure}[tb]
\centering
\includegraphics{./pic/test2LaTeX_76_2.png}
...
See Listing~\ref{lst:autolistingcell99} for the code.
...
See Listing~\ref{lst:autolistingcell103} for the code  to create the dataframe and write the output to LaTeX object at default font size.
...
\toprule
        A &         B &         C &         D \\
\midrule
-0.499672 &  0.444337 &  0.157120 &  1.172152 \\
-0.824540 &  1.439689 &  1.134088 &  1.737746 \\
-0.231630 & -1.529798 & -0.441057 &  0.489255 \\
-0.785652 & -0.964813 &  0.992210 & -0.788130 \\
-0.324326 & -0.133479 &  2.699443 & -1.080114 \\
 0.245934 &  0.278880 &  0.062924 &  0.567669 \\
\bottomrule
\end{tabular}
...
See Listing~\ref{lst:autolistingcell106} for the code  to write the table in LARGE.
...
See Listing~\ref{lst:autolistingcell108} for the code  to write a floating table in tiny font size.
...
See Listing~\ref{lst:autolistingcell110} for the code  display a tikz graphic.
...
See Listing~\ref{lst:autolistingcell111} for the code  display another tikz graphic, as a floating figure.
...
See Listing~\ref{lst:autolistingcell115} for the code  to format a numy array in \LaTeX{}.
...
See Listing~\ref{lst:autolistingcell122} for the code  to get software versions.
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 122 \label{lst:autolistingcell122}}]
...
\begin{lstlisting}[style=incellstyle,caption={Code Listing in cell 123 \label{lst:autolistingcell123}}]
